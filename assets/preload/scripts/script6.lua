...
function onUpdate()
	if songName == 'Freeplay' then
MainGamepadUpdate()
              if androidPadJustPress('b') or androidPadJustPress('b') then
			exitMenu()
              end
		...
		if androidPadJustPress('up') or androidPadJustPress('down') then
			...
			if ProductSelected >= MaxProductLimit and androidPadJustPress('up') then
				ProductSelected = 1
			elseif ProductSelected <= MinProductLimit and androidPadJustPress('down') then
				ProductSelected = 2
			elseif ProductSelected <= MinProductLimit and androidPadJustPress('down') then
				ProductSelected = 3
			else
...
function onTimerCompleted(tag, loops, loopsLeft)
	if androidPadJustPress('b') and songName == 'Freeplay' then
		exitMenu();
	end
end
